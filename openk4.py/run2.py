...
Camera_intrinsic = {
    ...
    "mtx": np.array([[8.95928165e+02,0.00000000e+00,1.08937880e+03],[0.00000000e+00,1.00382207e+03,6.92643453e+02],[0.00000000e+00,0.00000000e+00,1.00000000e+00]]
                    ,dtype=np.double),
    "dist": np.array([[-0.31205991,0.42359146,-0.02616497,-0.0177766,-0.05112838]], dtype=np.double),

}
Object = {"height": 105, "width": 150}

# 初始的HSV GUI滑块值在程序启动时加载
icol = {
    # lowHue,highHue,lowSat,highSat,lowVal,highVal
    "icol_black": (0, 180, 0, 255, 0, 46),  
    "icol_gray": (0, 180, 0, 43, 46, 220),
    "icol_white": (0, 180, 0, 30, 221, 255),  
